...
export const PAGE_ROUTE_REMEMBER_WORDS = "/remember_words";
export const PAGE_ROUTE_404 = "/404";

export const PAGE_ROUTE_LEARN_ROOT = "/learn";
export const PAGE_ROUTE_LEARN_GRAPHQL = PAGE_ROUTE_LEARN_ROOT + "/graphQL";
